      ...
      child: ListView(
        children: [
          ...
          GridView.count(
            ...
            children: [
              for (final card in cards) _RoomCard(data: card),
              _AddRoomCard(
                onAdd: (name, size) => controller.addCustomRoom(name, size),
              ),
            ],
          ),
          const SizedBox(height: NinhoSpacing.stackLg),
            ...
            children: [
              Row(
                children: [
                  ...
                  const Spacer(),
                  Icon(Icons.photo_camera, size: 18, color: palette.muted),
                ],
              ),
              const Spacer(),
              Text(
...
class _AddRoomCard extends StatelessWidget {
  const _AddRoomCard({required this.onAdd});
