...
- **Fase atual:** 10 — Feed em andamento (timeline, detalhe, realtime e moderação implementados; resumo IA pendente)
- **Última atualização:** 2026-05-22
- **Pendência aberta:** Fase 10 ainda precisa do resumo semanal via IA (Edge Function + Cron + eval suite).
